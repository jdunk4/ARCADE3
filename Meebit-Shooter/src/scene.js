...
import { ARENA, CHAPTERS, CHAPTER_BASE, WAVES_PER_CHAPTER } from './config.js';
...
export function strengthForWave(localWave) {
  // Wave 1..5 inside a chapter: 0.22, 0.4, 0.58, 0.76, 1.0
  return 0.22 + ((localWave - 1) / (WAVES_PER_CHAPTER - 1)) * 0.78;
}
