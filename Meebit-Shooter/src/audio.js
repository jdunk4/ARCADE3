...
class AudioEngine {
  ...
  // bullet that lands. Kept quiet (gainStart 0.05) so it stacks
  // under the gun sound without crowding the audio mix during a
  // 20-shot egg break. High-frequency to read as "ceramic clack."
  eggHit() {
    this._noise(0.04, 2400, 0.08);
    this._beep({ type: 'triangle', freqStart: 880, freqEnd: 660, dur: 0.05, gainStart: 0.05 });
  }
