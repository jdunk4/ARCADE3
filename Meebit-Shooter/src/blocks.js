...
// instead of an ore. Per design, mining is dangerous now — most blocks
// hide enemies. Player still gets some ores so the wave can complete.
const CH7_MEGA_BRUTE_REVEAL_CHANCE = 0.75;
