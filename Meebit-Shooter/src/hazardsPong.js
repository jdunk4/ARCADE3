...
// Inner safe radius — innermost ring stops here so the player has a
// dead-center safe zone. Smaller than full center because if rings go
// all the way in, the arena becomes a death floor with no escape.
const SAFE_INNER = 8.0;

// Maximum number of rings — ARENA - SAFE_INNER divided by RING_WIDTH,
// capped at 6 so we don't try to fill 10+ rings on a single chapter.
function _ringCount() {
