...
export function printChapterHeaderOnce(herdId) {
  ...
  // Blank line above the header for vertical separation between chapters.
  // Then a thick rule line + chapter label in the chapter's tint color.
  console.info(
    '\n%c── Chapter ' + t.chapter + ' · ' + t.name + ' · ' + herdId + ' ──',
    `color:${t.color}; font-weight:bold; font-size:13px; text-shadow:0 0 6px ${t.color}`,
  );
}
